        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4">
            {[
              ...
              { href: '/card-triad', title: 'Card Triad', description: '3×3 grid battle — cards have 4 edge numbers from real stats. Capture opponent cards with higher edges.', icon: '🎯', color: 'from-emerald-900/50 to-teal-900/30', border: 'border-emerald-800/30 hover:border-emerald-600/50' },
              { href: '/tools/monte-carlo', title: 'Monte Carlo Simulator', description: '10,000 price paths for any card. See the full distribution — median, P5/P95, probability of gain.', icon: '📊', color: 'from-cyan-900/50 to-blue-900/30', border: 'border-cyan-800/30 hover:border-cyan-600/50' },
              { href: '/op-ed', title: 'The Op-Ed', description: 'Daily hobby opinion column. 5 rotating columnists, 1 topic, a new take every 24 hours.', icon: '🗞️', color: 'from-amber-900/50 to-yellow-900/30', border: 'border-amber-800/30 hover:border-amber-600/50' },
              { href: '/mailbag', title: 'Dear Auntie Mint', description: 'Weekly advice column — 12 reader questions answered by Auntie Mint. Straight-talk on selling, grading, family, and ethics.', icon: '✉️', color: 'from-amber-900/50 to-orange-900/30', border: 'border-amber-800/30 hover:border-amber-600/50' },
              ...
              { href: '/market-roundtable', title: 'Market Roundtable', description: '5 analysts debate today\'s hottest card topic — vote for the best take', icon: '🎙️', color: 'from-slate-900/50 to-sky-900/30', border: 'border-slate-800/30 hover:border-sky-600/50' },
              ...
              { href: '/vault/market-maker', title: 'Market Maker', description: 'Be the dealer — set bid/ask spreads and trade with AI collectors', icon: '📈', color: 'from-emerald-900/50 to-teal-900/30', border: 'border-emerald-800/30 hover:border-emerald-600/50' },
              { href: '/vault/raffle', title: 'Card Raffle', description: 'Enter card raffles — buy tickets, watch drawings, win prizes', icon: '🎟️', color: 'from-teal-900/50 to-cyan-900/30', border: 'border-teal-800/30 hover:border-teal-600/50' },
              { href: '/break-bingo', title: 'Break Bingo', description: 'Bingo meets card breaks — watch pulls, mark your card, call BINGO!', icon: '🎱', color: 'from-cyan-900/50 to-blue-900/30', border: 'border-cyan-800/30 hover:border-cyan-600/50' },
              { href: '/tools/collection-heatmap', title: 'Collection Heatmap', description: 'Visualize 9,500+ cards by sport, decade, value — find gaps', icon: '🗺️', color: 'from-violet-900/50 to-purple-900/30', border: 'border-violet-800/30 hover:border-violet-600/50' },
              { href: '/card-chain', title: 'Card Chain', description: 'Build the longest chain — each card connects to the last', icon: '🔗', color: 'from-cyan-900/50 to-teal-900/30', border: 'border-cyan-800/30 hover:border-cyan-600/50' },
              { href: '/card-gauntlet', title: 'Card Gauntlet', description: 'Endless survival — pick the pricier card, 3 lives, escalating difficulty', icon: '🔥', color: 'from-rose-900/50 to-red-900/30', border: 'border-rose-800/30 hover:border-rose-600/50' },
              { href: '/market-psychology', title: 'Market Psychology', description: '12 cognitive biases costing collectors money — take the self-assessment', icon: '🧠', color: 'from-purple-900/50 to-violet-900/30', border: 'border-purple-800/30 hover:border-purple-600/50' },
              { href: '/card-top-trumps', title: 'Card Top Trumps', description: 'Pick your strongest stat to beat the CPU — 10 round battle', icon: '🃏', color: 'from-teal-900/50 to-cyan-900/30', border: 'border-teal-800/30 hover:border-teal-600/50' },
              { href: '/vault/auction', title: 'Auction House', description: 'Bid against 4 AI collectors — $500 budget, 5 lots, 15s bidding windows', icon: '🔨', color: 'from-amber-900/50 to-yellow-900/30', border: 'border-amber-800/30 hover:border-amber-600/50' },
              { href: '/card-thrift', title: 'Card Thrift Store', description: 'Bargain bin dig — 20 unmarked cards, pick 10 for $50, flip to reveal', icon: '🛍️', color: 'from-orange-900/50 to-amber-900/30', border: 'border-orange-800/30 hover:border-orange-600/50' },
              { href: '/autographs-guide', title: 'Autographs Guide', description: 'On-card vs sticker, RPA premiums, logoman & shield — full authentication playbook', icon: '✍️', color: 'from-amber-900/50 to-yellow-900/30', border: 'border-amber-800/30 hover:border-amber-600/50' },
              { href: '/card-hall-of-fame', title: 'Card Hall of Fame', description: '60 most iconic cards ever — Wagner, Mantle, Jordan, Gretzky, Brady. Build your Mount Rushmore.', icon: '🏛️', color: 'from-amber-900/50 to-yellow-900/30', border: 'border-amber-800/30 hover:border-amber-600/50' },
              { href: '/vault/loan-office', title: 'Card Loan Office', description: 'Borrow cash against your cards — 3 lenders, real LTV & APR math, no real money', icon: '🏦', color: 'from-amber-900/50 to-yellow-900/30', border: 'border-amber-800/30 hover:border-amber-600/50' },
              { href: '/opening-bell', title: 'The Opening Bell', description: 'Daily 5-segment morning show — Gainer, Loser, One to Watch. New episode every 24 hours.', icon: '🔔', color: 'from-rose-900/50 to-red-900/30', border: 'border-rose-800/30 hover:border-red-600/50' },
              { href: '/auction-paddle', title: 'Live Auction Paddle', description: 'Five houses running live — Heritage, Goldin, PWCC, REA, Lelands. Raise the paddle, hear the chant.', icon: '🪧', color: 'from-red-900/50 to-rose-900/30', border: 'border-red-800/30 hover:border-red-600/50' },
              { href: '/tools/collection-narrative', title: 'Collection Narrative', description: 'Turn your 5-20 cards into a shareable story — archetype, vibe, signature card, 3-paragraph writeup', icon: '📖', color: 'from-fuchsia-900/50 to-pink-900/30', border: 'border-fuchsia-800/30 hover:border-fuchsia-600/50' },
              { href: '/parallel-rainbow', title: 'Parallel Rainbow Encyclopedia', description: 'Every refractor, Prizm & parallel explained — 8 systems, 75+ parallels, print runs, value multipliers', icon: '🌈', color: 'from-purple-900/50 to-cyan-900/30', border: 'border-purple-800/30 hover:border-purple-600/50' },
              { href: '/tools/true-cost', title: 'True-Cost Calculator', description: 'Real annual cost of your collection — storage, insurance, time, opportunity cost vs S&P 500', icon: '💰', color: 'from-emerald-900/50 to-teal-900/30', border: 'border-emerald-800/30 hover:border-emerald-600/50' },
              { href: '/card-pairs', title: 'Card Pair Trader', description: 'Pick 2 of 4 cards closest to a target value — 10 rounds, daily challenge, shareable', icon: '🎯', color: 'from-indigo-900/50 to-violet-900/30', border: 'border-indigo-800/30 hover:border-indigo-600/50' },
              { href: '/famous-error-cards', title: 'Famous Error Cards', description: 'Hall of Infamy — 30 legendary printing mistakes. Billy Ripken FF, Frank Thomas NNOF, Sherry Magie, Dale Murphy reverse.', icon: '❌', color: 'from-rose-900/50 to-amber-900/30', border: 'border-rose-800/30 hover:border-rose-600/50' },
              { href: '/vault/ship-it', title: 'Shipping Simulator', description: 'You sold a card — now pack and ship it. Packing tiers, 6 carriers, insurance, signature. Get your Ship Grade.', icon: '📦', color: 'from-sky-900/50 to-blue-900/30', border: 'border-sky-800/30 hover:border-sky-600/50' },
              { href: '/vault/bill-of-sale', title: 'Bill of Sale Generator', description: 'Generate a proper bill of sale for private card transactions — insurance-ready, tax-compliant, print or PDF.', icon: '📝', color: 'from-stone-900/50 to-zinc-900/30', border: 'border-stone-800/30 hover:border-stone-600/50' },
              { href: '/vault/shipping-claim', title: 'Shipping Insurance Claim', description: 'Draft a USPS / UPS / FedEx claim letter for a lost or damaged card shipment. Carrier-specific evidence checklist + filing deadlines.', icon: '📦', color: 'from-teal-900/50 to-cyan-900/30', border: 'border-teal-800/30 hover:border-teal-600/50' },
              { href: '/vault/trade-contract', title: 'Trade Contract Generator', description: 'Two-party swap agreement. List cards each side gives, auto-balance with cash boot, set inspection window + grading-dispute arbiter, print signed copies.', icon: '🤝', color: 'from-blue-900/50 to-slate-900/30', border: 'border-blue-800/30 hover:border-blue-600/50' },
              { href: '/vault/break-agreement', title: 'Break Agreement Generator', description: 'Group break participation contract. Random Team / PYT / Hit Draft / PYP formats, up to 32 participants, randomizer + shipping + hits + dispute policies. Share before the buy-in.', icon: '🎲', color: 'from-indigo-900/50 to-slate-900/30', border: 'border-indigo-800/30 hover:border-indigo-600/50' },
              { href: '/estate-sale', title: 'Estate Sale Simulator', description: 'You inherited a collection — 15 cards, 4 liquidation paths. Quick-sell, online, consign, or keep. Earn your Executor Grade.', icon: '📦', color: 'from-stone-900/50 to-amber-900/30', border: 'border-stone-800/30 hover:border-amber-600/50' },
              { href: '/closing-bell', title: 'The Closing Bell', description: 'Daily 5-segment wrap-up — Final Tape, Top 3 Winners, Top 3 Losers, After-Hours, Overnight Setup. New at every close.', icon: '🧾', color: 'from-indigo-900/50 to-violet-900/30', border: 'border-indigo-800/30 hover:border-indigo-600/50' },
              { href: '/breakers-lounge', title: 'Breakers Lounge Live', description: 'Who\'s on the air right now? 8 breaker personalities, live viewer counts, recent hits, next-break countdowns. Follow your favorites.', icon: '🎙️', color: 'from-violet-900/50 to-fuchsia-900/30', border: 'border-violet-800/30 hover:border-violet-600/50' },
              { href: '/mailday', title: 'Mailday Live', description: 'The arrivals feed — PSA returns, eBay deliveries, card show pickups, break shipments, trade arrivals. A new hobby mail drop every 5 seconds.', icon: '📬', color: 'from-teal-900/50 to-cyan-900/30', border: 'border-teal-800/30 hover:border-teal-600/50' },
              { href: '/card-darts', title: 'Card Darts', description: 'Throw 3 darts at the CardVault board. Bullseye = grail tier, outer ring = commons. Time the aim meter, reveal real cards.', icon: '🎯', color: 'from-red-900/50 to-rose-900/30', border: 'border-red-800/30 hover:border-red-600/50' },
              { href: '/card-poker', title: 'Card Poker', description: 'Deal 7 real sports cards, pick 5 for your best poker hand. Same-year = pairs, same-sport 5 = Flush, 5 rookies same sport = Royal Flush.', icon: '🎴', color: 'from-green-900/50 to-emerald-900/30', border: 'border-green-800/30 hover:border-green-600/50' },
              { href: '/tools/hold-optimizer', title: 'Hold Optimizer', description: 'When is the best year to sell? 20-year projection minus storage, insurance, and S&P opportunity cost. Flip Now, Short Hold, Long Hold, or Grail.', icon: '⏳', color: 'from-emerald-900/50 to-teal-900/30', border: 'border-emerald-800/30 hover:border-emerald-600/50' },
              { href: '/tools/yield-comparator', title: 'Yield Comparator', description: 'Rank 2-6 cards head-to-head by annualized yield after carry + S&P opportunity cost. Normalized per dollar invested. Gold medal for best return.', icon: '🥇', color: 'from-amber-900/50 to-yellow-900/30', border: 'border-amber-800/30 hover:border-yellow-600/50' },
              { href: '/tools/import-calculator', title: 'Import Calculator', description: 'Buying from Japan, UK, Canada, Germany? True landed cost — duty, CBP, broker, state use tax. $800 de minimis explained. 10 origin countries.', icon: '🌍', color: 'from-sky-900/50 to-cyan-900/30', border: 'border-sky-800/30 hover:border-sky-600/50' },
              { href: '/tools/export-calculator', title: 'Export Calculator', description: 'Selling to Japan, UK, Germany, Australia? True net — USPS International, platform fees, PayPal cross-border, IOSS/VAT, return-risk buffer. 10 destinations.', icon: '📦', color: 'from-fuchsia-900/50 to-pink-900/30', border: 'border-fuchsia-800/30 hover:border-fuchsia-600/50' },
              { href: '/tools/counterfeit-scanner', title: 'Counterfeit Risk Scanner', description: 'Before you hit Pay: check venue, seller, photos, price, and encapsulation. 0-100 risk score with red flags. 18 hot-target card families.', icon: '🛡️', color: 'from-rose-900/50 to-red-900/30', border: 'border-rose-800/30 hover:border-rose-600/50' },
              { href: '/tools/shill-detector', title: 'Shill Bid Detector', description: 'Before you raise your bid: score the auction for shill risk. 9 signal axes across bidder age, top-share, timing, reserve, cross-listing, retractions. 0-100 verdict with playbook.', icon: '🎯', color: 'from-yellow-900/50 to-amber-900/30', border: 'border-yellow-800/30 hover:border-yellow-600/50' },
              { href: '/tools/chargeback-scanner', title: 'Chargeback Risk Scanner', description: 'Before you ship: seller-side score for chargeback exposure. Payment platform + buyer profile + photos + shipping + destination + returns. 0-100 with pre-ship hardening checklist.', icon: '🚫', color: 'from-red-900/50 to-rose-900/30', border: 'border-red-800/30 hover:border-red-600/50' },
              { href: '/card-briefcase', title: 'Card Briefcase', description: 'Deal or no deal — sixteen briefcases, sixteen real cards. Pick one, eliminate the rest, take the Banker\u2019s offer or play on for a grail. Daily shared game.', icon: '💼', color: 'from-emerald-900/50 to-green-900/30', border: 'border-emerald-800/30 hover:border-emerald-600/50' },
              { href: '/card-mastermind', title: 'Card Mastermind', description: 'A mystery card is hidden — crack it in 10 guesses. Green / yellow / white feedback on decade, sport, rookie, and value tier. Daily puzzle.', icon: '🎯', color: 'from-violet-900/50 to-indigo-900/30', border: 'border-violet-800/30 hover:border-violet-600/50' },
              { href: '/card-dozen', title: 'Card Dozen', description: 'Twelve real cards. Thirty seconds. Pick the three you think are worth the most money. Gold at 95, silver at 80, bronze at 60, bust below. Daily challenge across four sports.', icon: '🎰', color: 'from-lime-900/50 to-green-900/30', border: 'border-lime-800/30 hover:border-lime-600/50' },
              { href: '/card-echo', title: 'Card Echo', description: 'Simon says with real sports cards. Watch the flash pattern, tap the cards back in order. Each round adds one to remember. Three speed tiers, daily shared puzzle.', icon: '🔊', color: 'from-cyan-900/50 to-sky-900/30', border: 'border-cyan-800/30 hover:border-cyan-600/50' },
              { href: '/tools/proxy-bid', title: 'Proxy Bid Optimizer', description: 'Before you enter that max bid — see what you will actually pay. Real eBay 10-tier increment ladder, second-price clearing math, 4-rival modeling, and snipe-timing strategy.', icon: '🎯', color: 'from-indigo-900/50 to-blue-900/30', border: 'border-indigo-800/30 hover:border-indigo-600/50' },
              { href: '/ceiling-breaks', title: 'Ceiling Break Live', description: 'Live feed of cards crossing $100, $500, $1K, $5K, $10K, $50K, $100K for the first time. Four milestone types — ATH, 12-month high, 7-day breakout, recovery. Seven tiers, sport + type filters, watchlist.', icon: '💖', color: 'from-fuchsia-900/50 to-rose-900/30', border: 'border-fuchsia-800/30 hover:border-fuchsia-600/50' },
              { href: '/auction-wire', title: 'Auction Wire', description: 'Live countdown feed of twelve hobby auctions ending across eBay, PWCC, Goldin, Heritage, Whatnot, and MySlabs. Tier-coded urgency, real-time bids, 6th P4 Live feed.', icon: '⏱️', color: 'from-indigo-900/50 to-violet-900/30', border: 'border-indigo-800/30 hover:border-indigo-600/50' },
              { href: '/pop-watch', title: 'Pop Watch', description: 'Live pop-report feed across PSA, BGS, CGC, SGC. Watch grade-outs as they land, flag bulk-return saturation, star grail pops. Watchlist your slabs.', icon: '📊', color: 'from-teal-900/50 to-cyan-900/30', border: 'border-teal-800/30 hover:border-teal-600/50' },
              { href: '/grail-watch', title: 'Grail Watch Live', description: 'The $1K+ ticker. Auction hammers, private sales, trade packages, break pulls, mailday returns — one feed for every grail-tier moment. Value-tier, sport, context filters; starrable watchlist.', icon: '✨', color: 'from-yellow-900/50 to-amber-900/30', border: 'border-yellow-800/30 hover:border-yellow-600/50' },
              { href: '/card-companies', title: 'Card Companies Ranked', description: '120 years of sports card manufacturers tiered. Titan, Pillar, Classic, Niche. Topps, Upper Deck, Panini, Bowman, Fleer, Donruss, Pacific, Pinnacle, Leaf, Score, SkyBox, SP, Playoff, Fanatics, ITG, and the T206 tobacco trust. Editorial rankings with rationale and voting.', icon: '🏛️', color: 'from-teal-900/50 to-cyan-900/30', border: 'border-teal-800/30 hover:border-teal-600/50' },
              { href: '/almanac', title: 'The Hobby Almanac', description: 'The 12-month calendar for card collecting. When the market is hot, cold, peaking, building, or steady — every month with releases, events, storylines, and buy/sell timing advice. Time your spending to the hobby year.', icon: '📆', color: 'from-orange-900/50 to-amber-900/30', border: 'border-orange-800/30 hover:border-orange-600/50' },
              { href: '/regrade-reel', title: 'Regrade Reel', description: 'Live crossover + crack-and-resub feed across PSA, BGS, CGC, SGC. Five outcome tiers from GRAIL UPGRADE to DISASTER with net value deltas. The hobby\u2019s biggest gamble, live.', icon: '🎰', color: 'from-orange-900/50 to-rose-900/30', border: 'border-orange-800/30 hover:border-orange-600/50' },
              { href: '/set-archives', title: 'Set Archives', description: 'The Greatest Card Sets of All Time — editorial tier ranking of 40 legendary sports card sets. T206 to modern Prizm across MLB, NBA, NFL, NHL.', icon: '📚', color: 'from-purple-900/50 to-indigo-900/30', border: 'border-purple-800/30 hover:border-purple-600/50' },
              { href: '/product-rankings', title: 'Product Rankings', description: 'The Greatest Card Products of All Time — 30 release lines ranked by tier. National Treasures, The Cup, Bowman Chrome, Topps Chrome, Prizm, Contenders Optic.', icon: '🏅', color: 'from-cyan-900/50 to-teal-900/30', border: 'border-cyan-800/30 hover:border-cyan-600/50' },
              { href: '/auction-archive', title: 'Auction Archive', description: 'The greatest card hammers ever. 40 legendary auction results with stories — $12.6M Mantle, $5.3M Pikachu Illustrator, $3.1M Contenders Brady. Mega / Elite / Major / Notable tiers.', icon: '🪙', color: 'from-amber-900/50 to-yellow-900/30', border: 'border-amber-800/30 hover:border-amber-600/50' },
              { href: '/year-in-cards', title: 'The Year in Cards', description: 'Six calendar years graded. 2020 boom, 2021 peak, 2022 crash, 2023 reset, 2024 recovery, 2025 normal year. Top stories, big hammers, product launches, industry events, watershed moments.', icon: '📅', color: 'from-indigo-900/50 to-violet-900/30', border: 'border-indigo-800/30 hover:border-indigo-600/50' },
              { href: '/draft-rewind', title: '2003 NBA Draft Rewind', description: 'Twenty-three years later: every major rookie card from the most important NBA Draft in hobby history. LeBron, Wade, Carmelo, Bosh, Darko, Korver, and nine more. Peak auction comps, 2026 values, career arcs.', icon: '🏀', color: 'from-sky-900/50 to-slate-900/30', border: 'border-sky-800/30 hover:border-sky-600/50' },
              { href: '/card-show-booth', title: 'Card Show Booth Simulator', description: 'Rent a booth, price 18 cards, field 20 offers from 8 collector personas. Accept, counter, or reject. Earn your Booth Grade.', icon: '🎪', color: 'from-orange-900/50 to-amber-900/30', border: 'border-orange-800/30 hover:border-orange-600/50' },
              { href: '/card-zodiac', title: 'Card Zodiac', description: 'Enter your birthday — discover your Card Zodiac sign. 12 collector archetypes, each with a ruling sport, lucky number, and grail card from the 9,840-card database.', icon: '♈', color: 'from-indigo-900/50 to-violet-900/30', border: 'border-indigo-800/30 hover:border-indigo-600/50' },
              { href: '/tools/player-portfolio', title: 'Player Portfolio', description: 'Search any player — see all their cards, total value, investment grade', icon: '📊', color: 'from-indigo-900/50 to-purple-900/30', border: 'border-indigo-800/30 hover:border-indigo-600/50' },
