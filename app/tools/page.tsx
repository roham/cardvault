    ...
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <div className="flex flex-wrap gap-3 mb-12">
        {[
          ...
          { href: '/tools/listing-helper', label: 'Smart Listing Advisor', icon: '🎯' },
          ...
          { href: '/tools/card-dimensions', label: 'Card Dimensions Guide', icon: '📐' },
          ...
          { href: '/tools/cost-basis', label: 'Cost Basis Aggregator', icon: '🧮' },
          ...
          { href: '/tools/tax1099k-tracker', label: '1099-K Threshold Tracker', icon: '📋' },
