  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <div className="mt-8 grid grid-cols-1 sm:grid-cols-3 gap-3">
        ...
        <Link href="/vault/trade-up-ladder" className="flex items-center gap-3 px-4 py-3 bg-gray-900/60 border border-gray-800 hover:border-gray-600 rounded-xl transition-colors">
          <span className="text-xl">🪜</span>
          <div>
            <div className="text-white text-sm font-medium">Trade-Up Ladder</div>
            <div className="text-gray-500 text-xs">Plan a multi-step trade route</div>
          </div>
        </Link>
        ...
        <Link href="/vault/power-of-attorney" className="flex items-center gap-3 px-4 py-3 bg-gray-900/60 border border-gray-800 hover:border-gray-600 rounded-xl transition-colors">
          <span className="text-xl">✒️</span>
          <div>
            <div className="text-white text-sm font-medium">Power of Attorney</div>
